...
void Scene::initLights() {
    ...
    spheresLight.push_back(new Sphere(materialList.metal_tile, glm::vec3(0, 0, 0)));
    spheresLight.push_back(new Sphere(materialList.metal_tile, glm::vec3(0, 0, 0)));
    spheresLight.push_back(new Sphere(materialList.metal_tile, glm::vec3(0, 0, 0)));
    spheresLight.push_back(new Sphere(materialList.metal_tile, glm::vec3(0, 0, 0)));
}
...
void Scene::setShaders(Shader _pbrShader, Shader _equirectangularToCubemapShader, Shader _irradianceShader, Shader _prefilterShader, Shader _brdfShader, Shader _backgroundShader) {
    pbrShader = _pbrShader;
    equirectangularToCubemapShader = _equirectangularToCubemapShader;
    irradianceShader = _irradianceShader;
    prefilterShader = _prefilterShader;
    brdfShader = _brdfShader;
...
void Scene::initBuffer() {
    ...
    unsigned int hdrTexture = MaterialList::loadEnvMap();
...
void Scene::renderScene() {
    ...
    pbrShader.setVec3("camPos", globalCamera.Position);
    ...
    for (int idxSphere = 0; idxSphere < nbSphere; ++idxSphere) {
        ...
        spheres[idxSphere]->renderSphere();
    }
